//Верхний Тулбар
Ext.define("PartionnyAccount.controller.Sklad/Container/controllerContainerCentral", {
    //Расширить
    extend: "Ext.app.Controller",
    //views: ['Container/viewContainerCentral'],

    init: function () {
        this.control({

            //Настройки *** *** ***
            'viewContainerCentral menuitem#onToggleConfig1': { click: this.onToggleConfig },
            'viewContainerCentral menuitem#onToggleConfig2': { click: this.onToggleConfig },

            'viewContainerCentral button#onToggleMicro': { click: this.onToggleMicro },
            'viewContainerCentral button#onToggleNav': { click: this.onToggleNav }
    ...
    onToggleNav: function (button, pressed) {
        ...
        treelist[pressed ? 'addCls' : 'removeCls']('treelist-with-nav');
