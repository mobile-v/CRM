        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                //Наименование
                {
                    ...
                    items: [
                        //{ xtype: 'textfield', fieldLabel: lanArticle, name: "DirServiceNomenArticle", id: "DirServiceNomenArticle" + this.UO_id, flex: 1, allowBlank: true },
                    ...
                    items: [
                        {
                            ...
                            store: this.storeDirServiceNomenCategoriesGrid, // store getting items from server
                            valueField: 'DirServiceNomenCategoryID',
                            hiddenName: 'DirServiceNomenCategoryID',
                            displayField: 'DirServiceNomenCategoryName',
                            name: 'DirServiceNomenCategoryID', itemId: "DirServiceNomenCategoryID", id: "DirServiceNomenCategoryID" + this.UO_id,
                            UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                        ...
                        { xtype: 'button', tooltip: "Edit", iconCls: "button-image-edit", itemId: "btnDirServiceNomenCategoryEdit", id: "btnDirServiceNomenCategoryEdit" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall },
                        { xtype: 'button', tooltip: "Reload", iconCls: "button-image-reload", itemId: "btnDirServiceNomenCategoryReload", id: "btnDirServiceNomenCategoryReload" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall },
                        { xtype: 'button', tooltip: "Clear", itemId: "btnDirServiceNomenCategoryClear", text: "X", UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall }
                    ]
                },
