...
namespace PartionnyAccount.Controllers.Sklad.Dir.DirBanks
{
    public class DirBanksController : ApiController
    {
        #region Classes
        ...
        // GET: api/DirBanks
        public async Task<IHttpActionResult> GetDirBanks(HttpRequestMessage request)
        {
            try
            {
                ...
                if (_params.type == "Grid")
                {
                    ...
                    var query =
                        (
                            from dirBanks in db.DirBanks
                            select new
                            {
                                DirBankID = dirBanks.DirBankID,
                                Del = dirBanks.Del,
                                SysRecord = dirBanks.SysRecord,
                                DirBankName = dirBanks.DirBankName,
                                DirCurrencyName = dirBanks.dirCurrency.DirCurrencyName,
                                DirBankSum = dirBanks.DirBankSum
                            }
                        );
                    ...
                    if (!String.IsNullOrEmpty(_params.parSearch))
                    {
                        ...
                        if (bResult32)
                        {
                            query = query.Where(x => x.DirBankID == iNumber32 || x.DirBankName.Contains(_params.parSearch));
                        }
                        else
                        {
                            query = query.Where(x => x.DirBankName.Contains(_params.parSearch));
                        }
                    }
                    ...
                    query = query.OrderBy(x => x.DirBankName).Skip(_params.Skip).Take(_params.limit);
                    ...
                    //К-во Номенклатуры
                    int dirCount = await Task.Run(() => db.DirBanks.Count());
        ...
        // GET: api/DirBanks/5
        [ResponseType(typeof(DirBank))]
        public async Task<IHttpActionResult> GetDirBank(int id, HttpRequestMessage request)
        {
            try
            {
                #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
                ...
                var query = await Task.Run(() =>
                    (
                        ...
                        select new
                        {
                            ...
                            Del = x.Del,
                            DirBankName = x.DirBankName,
                            DirCurrencyID = x.DirCurrencyID,
                            DirCurrencyName = x.dirCurrency.DirCurrencyName,

                            DirBankMFO = x.DirBankMFO,
                            DirBankCurrAccount = x.DirBankCurrAccount,
                            DirBankCorrAccount = x.DirBankCorrAccount,
                            DirBankTIN = x.DirBankTIN,
                            DirBankSWIFT = x.DirBankSWIFT,
                            DirBankBIC = x.DirBankBIC,
                            DirBankPhone = x.DirBankPhone,
                            DirBankFax = x.DirBankFax,
                            DirBankEMail = x.DirBankEMail,
        ...
        public async Task<IHttpActionResult> PutDirBank(int id, DirBank dirBank)
        {
            ...
            if (id != dirBank.DirBankID) return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg8)); //return BadRequest();
        ...
        // POST: api/DirBanks
        [ResponseType(typeof(DirBank))]
        public async Task<IHttpActionResult> PostDirBank(DirBank dirBank)
        {
            #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
            ...
            try
            {
                db.Entry(dirBank).State = EntityState.Added;
                await Task.Run(() => db.SaveChangesAsync());
        ...
        // DELETE: api/DirBanks/5
        [ResponseType(typeof(DirBank))]
        public async Task<IHttpActionResult> DeleteDirBank(int id)
        {
            #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
            ...
            try
            {
                DirBank dirBank = await db.DirBanks.FindAsync(id);
                if (dirBank == null) return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg99));


                db.DirBanks.Remove(dirBank);
        ...
        private bool DirBankExists(int id)
        {
            return db.DirBanks.Count(e => e.DirBankID == id) > 0;
        }
