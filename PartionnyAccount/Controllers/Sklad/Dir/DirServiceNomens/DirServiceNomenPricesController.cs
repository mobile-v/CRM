...
{
    public class DirServiceNomenPricesController : ApiController
    {
        #region Classes
        ...
        // GET: api/DirServiceNomenPrices/5
        [ResponseType(typeof(DirServiceNomenPrice))]
        public async Task<IHttpActionResult> GetDirServiceNomenPrice(int id, HttpRequestMessage request)
        {
            try
            {
                #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
                ...
                var query = await Task.Run(() =>
                    (
                        ...
                        where x.DirServiceNomenPriceID == id
        ...
        // PUT: api/DirServiceNomenPrices/5
        [ResponseType(typeof(void))]
        public async Task<IHttpActionResult> PutDirServiceNomenPrice(int id, DirServiceNomenPrice dirServiceNomenPrice)
        {
            #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
            ...
            if (id != dirServiceNomenPrice.DirServiceNomenPriceID) return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg8)); //return BadRequest();

            //Подстановки - некоторые поля надо заполнить, если они не заполены
            //dirServiceNomenPrice.Substitute();
            ...
            try
            {
                db.Entry(dirServiceNomenPrice).State = EntityState.Modified;
        ...
        // POST: api/DirServiceNomenPrices
        [ResponseType(typeof(DirServiceNomenPrice))]
        public async Task<IHttpActionResult> PostDirServiceNomenPrice(DirServiceNomenPrice dirServiceNomenPrice)
        {
            #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
            ...
            try
            {
                ...
                db.Entry(dirServiceNomenPrice).State = EntityState.Added;
                await Task.Run(() => db.SaveChangesAsync());
        ...
        // DELETE: api/DirServiceNomenPrices/5
        [ResponseType(typeof(DirServiceNomenPrice))]
        public async Task<IHttpActionResult> DeleteDirServiceNomenPrice(int id)
        {
            ...
            try
            {
                ...
                if (dirServiceNomenPrice == null) return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg99));
        ...
        private bool DirServiceNomenPriceExists(int id)
        {
            return db.DirServiceNomenPrices.Count(e => e.DirServiceNomenPriceID == id) > 0;
        }
