...
{
    public class DirServiceJobNomenHistoriesController : ApiController
    {
        #region Classes
        ...
        class Params
        {
            ...
            public int DirServiceJobNomenID = 0;
        }
        // GET: api/DirServiceJobNomenHistories
        public async Task<IHttpActionResult> GetDirServiceJobNomenHistories(HttpRequestMessage request)
        {
            try
            {
                ...
                _params.DirServiceJobNomenID = Convert.ToInt32(paramList.FirstOrDefault(kv => string.Compare(kv.Key, "DirServiceJobNomenID", true) == 0).Value);
                ...
                var query =
                    (
                        from x in db.DirServiceJobNomenHistories
                        where x.DirServiceJobNomenID == _params.DirServiceJobNomenID
                        select new
                        {
                ...
                */
                ...
                dynamic collectionWrapper = new
                {
                    sucess = true,
                    total = dirCount,
                    DirServiceJobNomenHistory = query
                };
        ...
        // GET: api/DirServiceJobNomenHistories/5
        [ResponseType(typeof(DirServiceJobNomenHistory))]
        public async Task<IHttpActionResult> GetDirServiceJobNomenHistory(int id, HttpRequestMessage request)
        {
            try
            {
                #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
        ...
        // PUT: api/DirServiceJobNomenHistories/5
        [ResponseType(typeof(void))]
        public async Task<IHttpActionResult> PutDirServiceJobNomenHistory(int id, DirServiceJobNomenHistory dirServiceJobNomenHistory)
        {
            return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg57(0)));
        }

        // POST: api/DirServiceJobNomenHistories
        [ResponseType(typeof(DirServiceJobNomenHistory))]
        public async Task<IHttpActionResult> PostDirServiceJobNomenHistory(DirServiceJobNomenHistory dirServiceJobNomenHistory)
        {
            return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg57(0)));
        }

        // DELETE: api/DirServiceJobNomenHistories/5
        [ResponseType(typeof(DirServiceJobNomenHistory))]
        public async Task<IHttpActionResult> DeleteDirServiceJobNomenHistory(int id)
        {
            return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg57(0)));
        }
        ...
        private bool DirServiceJobNomenHistoryExists(int id)
        {
            return db.DirServiceJobNomenHistories.Count(e => e.DirServiceJobNomenHistoryID == id) > 0;
        }
