...
namespace PartionnyAccount.Controllers.Sklad.Dir.DirServiceContractors
{
    public class DirServiceContractorsController : ApiController
    {
        #region Classes
        ...
        // GET: api/DirServiceContractors/5
        [ResponseType(typeof(DirServiceContractor))]
        ...
        // PUT: api/DirServiceContractors/5
        [ResponseType(typeof(void))]
        public async Task<IHttpActionResult> PutDirServiceContractor(int id, DirServiceContractor dirServiceContractor)
        {
            #region Проверяем Логин и Пароль + Изменяем строку соединения + Права + Разные Функции
            ...
            if (id != dirServiceContractor.DirServiceContractorID) return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg8)); //return BadRequest();
        ...
        // POST: api/DirServiceContractors
        [ResponseType(typeof(DirServiceContractor))]
        ...
        // DELETE: api/DirServiceContractors/5
        [ResponseType(typeof(DirServiceContractor))]
        public async Task<IHttpActionResult> DeleteDirServiceContractor(int id)
        {
            ...
            try
            {
                ...
                if (dirServiceContractor == null) return Ok(returnServer.Return(false, Classes.Language.Sklad.Language.msg99));
        ...
        private bool DirServiceContractorExists(int id)
        {
            return db.DirServiceContractors.Count(e => e.DirServiceContractorID == id) > 0;
        }
