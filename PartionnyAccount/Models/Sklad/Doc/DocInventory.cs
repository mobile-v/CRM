...
namespace PartionnyAccount.Models.Sklad.Doc
{
    ...
    public class DocInventory
    {
        ...
        //Табличные данные *** *** *** *** *** *** *** *** *** ***
        [NotMapped]
        public string recordsDocInventoryTab { get; set; }
    ...
    [Table("DocInventoryTabs")]
    public class DocInventoryTab
    {
        [Key]
        public int? DocInventoryTabID { get; set; }

        [Display(Name = "Документ")]
        [Required]
        public int DocInventoryID { get; set; }
        [ForeignKey("DocInventoryID")]
        public virtual DocInventory docInventory { get; set; }
        ...
        [Required]
        public int DirNomenMinimumBalance { get; set; }
        ...
        [Display(Name = "Списать по приходной цене")]
        [Required]
        public double Quantity_WriteOff { get; set; }
        [Required]
        ...
        [Display(Name = "Оприходовать: приходная цена + расходные")]
        [Required]
        public double Quantity_Purch { get; set; }
