...
namespace PartionnyAccount.Models.Sklad.Doc
{
    ...
    {
        [Key]
        public int? DocAccountID { get; set; }
        ...
        //Табличные данные *** *** *** *** *** *** *** *** *** ***
        [NotMapped]
        public string recordsDocAccountTab { get; set; }
    ...
    [Table("DocAccountTabs")]
    public class DocAccountTab
    {
        [Key]
        public int? DocAccountTabID { get; set; }

        [Display(Name = "Документ")]
        [Required]
        public int DocAccountID { get; set; }
        [ForeignKey("DocAccountID")]
        public virtual DocAccount docAccount { get; set; }
