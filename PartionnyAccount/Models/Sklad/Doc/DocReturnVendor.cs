...
{
    [Table("DocReturnVendors")]
    public class DocReturnVendor
    {
        [Key]
        public int? DocReturnVendorID { get; set; }
        ...
        //Табличные данные *** *** *** *** *** *** *** *** *** ***
        [NotMapped]
        public string recordsDocReturnVendorTab { get; set; }
    ...
    [Table("DocReturnVendorTabs")]
    public class DocReturnVendorTab
    {
        [Key]
        public int? DocReturnVendorTabID { get; set; }

        [Display(Name = "Документ")]
        [Required]
        public int DocReturnVendorID { get; set; }
        [ForeignKey("DocReturnVendorID")]
        public virtual DocReturnVendor docReturnVendor { get; set; }
