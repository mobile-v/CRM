...
namespace PartionnyAccount.Models.Sklad.Doc
{
    ...
    public class DocRetail
    {
        ...
        //Табличные данные *** *** *** *** *** *** *** *** *** ***
        [NotMapped]
        public string recordsDocRetailTab { get; set; }
    ...
    [Table("DocRetailTabs")]
    public class DocRetailTab
    {
        [Key]
        public int? DocRetailTabID { get; set; }

        [Display(Name = "Документ")]
        [Required]
        public int? DocRetailID { get; set; }
        [ForeignKey("DocRetailID")]
        public virtual DocRetail docRetail { get; set; }
