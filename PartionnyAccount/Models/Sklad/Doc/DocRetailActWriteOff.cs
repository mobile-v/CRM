...
{
    [Table("DocRetailActWriteOffs")]
    public class DocRetailActWriteOff
    {
        [Key]
        public int? DocRetailActWriteOffID { get; set; }
        ...
        //Табличные данные *** *** *** *** *** *** *** *** *** ***
        [NotMapped]
        public string recordsDocRetailActWriteOffTab { get; set; }
    ...
    [Table("DocRetailActWriteOffTabs")]
    public class DocRetailActWriteOffTab
    {
        [Key]
        public int? DocRetailActWriteOffTabID { get; set; }

        [Display(Name = "Документ")]
        [Required]
        public int? DocRetailActWriteOffID { get; set; }
        [ForeignKey("DocRetailActWriteOffID")]
        public virtual DocRetailActWriteOff docRetailActWriteOff { get; set; }
