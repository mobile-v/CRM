Ext.define("PartionnyAccount.controller.Sklad/Object/Doc/DocAccounts/controllerDocAccountTabsEdit", {
    //Расширить
    ...
    init: function () {
        this.control({
            ...
            //Закрыте
            'viewDocAccountTabsEdit': { close: this.this_close },


            //Currencies
            'viewDocAccountTabsEdit [itemId=DirCurrencyID]': { select: this.onDirCurrencyIDSelect },
            //'viewDocAccountTabsEdit [itemId=DirCurrencyID]': { change: this.onDirCurrencyIDSelect },

            'viewDocAccountTabsEdit button#btnCurrencyEdit': { "click": this.onBtnCurrencyEditClick },
            'viewDocAccountTabsEdit button#btnCurrencyReload': { "click": this.onBtnCurrencyReloadClick },
            'viewDocAccountTabsEdit button#btnCurrencyClear': { "click": this.onBtnCurrencyClearClick },


            'viewDocAccountTabsEdit [itemId=DirCurrencyRate]': { change: this.onDirCurrencyRateChange },
            'viewDocAccountTabsEdit [itemId=DirCurrencyMultiplicity]': { change: this.onDirCurrencyMultiplicityChange },


            'viewDocAccountTabsEdit [itemId=PriceVAT]': { change: this.onPriceVATChange },
            'viewDocAccountTabsEdit [itemId=PriceCurrency]': { change: this.onPriceCurrencyChange },

            'viewDocAccountTabsEdit [itemId=Quantity]': { change: this.onQuantityChange },


            // === Кнопки: Сохранение, Отмена и Помощь === === ===
            'viewDocAccountTabsEdit button#btnSave': { "click": this.onBtnSaveClick },
            'viewDocAccountTabsEdit button#btnCancel': { "click": this.onBtnCancelClick },
            'viewDocAccountTabsEdit button#btnDel': { "click": this.onBtnDelClick },
        });
    },
    ...
    onBtnSaveClick: function (aButton, aEvent, aOptions) {
        fun_SaveTabDocNoChar1(aButton, controllerDocAccountsEdit_RecalculationSums);
    },
