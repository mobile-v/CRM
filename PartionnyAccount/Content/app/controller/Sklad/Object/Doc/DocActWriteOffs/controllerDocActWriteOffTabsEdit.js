Ext.define("PartionnyAccount.controller.Sklad/Object/Doc/DocActWriteOffs/controllerDocActWriteOffTabsEdit", {
    //Расширить
    ...
    init: function () {
        this.control({
            ...
            //Закрыте
            'viewDocActWriteOffTabsEdit': { close: this.this_close },


            //Currencies
            'viewDocActWriteOffTabsEdit [itemId=DirCurrencyID]': { select: this.onDirCurrencyIDSelect },
            //'viewDocActWriteOffTabsEdit [itemId=DirCurrencyID]': { change: this.onDirCurrencyIDSelect },

            'viewDocActWriteOffTabsEdit button#btnCurrencyEdit': { "click": this.onBtnCurrencyEditClick },
            'viewDocActWriteOffTabsEdit button#btnCurrencyReload': { "click": this.onBtnCurrencyReloadClick },
            'viewDocActWriteOffTabsEdit button#btnCurrencyClear': { "click": this.onBtnCurrencyClearClick },


            'viewDocActWriteOffTabsEdit [itemId=DirCurrencyRate]': { change: this.onDirCurrencyRateChange },
            'viewDocActWriteOffTabsEdit [itemId=DirCurrencyMultiplicity]': { change: this.onDirCurrencyMultiplicityChange },


            'viewDocActWriteOffTabsEdit [itemId=PriceVAT]': { change: this.onPriceVATChange },
            'viewDocActWriteOffTabsEdit [itemId=PriceCurrency]': { change: this.onPriceCurrencyChange },

            'viewDocActWriteOffTabsEdit [itemId=Quantity]': { change: this.onQuantityChange },


            // === Кнопки: Сохранение, Отмена и Помощь === === ===
            'viewDocActWriteOffTabsEdit button#btnSave': { "click": this.onBtnSaveClick },
            'viewDocActWriteOffTabsEdit button#btnCancel': { "click": this.onBtnCancelClick },
            'viewDocActWriteOffTabsEdit button#btnDel': { "click": this.onBtnDelClick },
        });
    },
    ...
    onBtnSaveClick: function (aButton, aEvent, aOptions) {
        fun_SaveTabDocNoChar1(aButton, controllerDocActWriteOffsEdit_RecalculationSums);
    },
