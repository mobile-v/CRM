Ext.define("PartionnyAccount.controller.Sklad/Object/Doc/DocMovements/controllerDocMovementsEdit", {
    //Расширить
    ...
    init: function () {
        this.control({
            ...
            //Закрыте
            'viewDocMovementsEdit': { close: this.this_close },

            //Сисок (itemId=tree)
            // Меню Списка
            'viewDocMovementsEdit [itemId=expandAll]': { click: this.onTree_expandAll },
            'viewDocMovementsEdit [itemId=collapseAll]': { click: this.onTree_collapseAll },
            'viewDocMovementsEdit [itemId=FolderNew]': { click: this.onTree_folderNew },
            'viewDocMovementsEdit [itemId=FolderNewSub]': { click: this.onTree_folderNewSub },
            'viewDocMovementsEdit [itemId=FolderEdit]': { click: this.onTree_FolderEdit },
            'viewDocMovementsEdit [itemId=FolderCopy]': { click: this.onTree_FolderCopy },
            'viewDocMovementsEdit [itemId=FolderDel]': { click: this.onTree_folderDel },
            // Клик по Группе
            'viewDocMovementsEdit [itemId=tree]': {
            ...
            //PanelParty
            // Клик по Гриду "Party"
            'viewDocMovementsEdit [itemId=gridParty]': {
            ...
            'viewDocMovementsEdit button#btnDirNomenReload': { click: this.onBtnDirNomenReloadClick },
            'viewDocMovementsEdit #TriggerSearchTree': {
            ...
            'viewDocMovementsEdit button#btnDirContractorEdit': { click: this.onBtnDirContractorEditClick },
            'viewDocMovementsEdit button#btnDirContractorReload': { click: this.onBtnDirContractorReloadClick },
            //Склад - Перегрузить
            //From
            'viewDocMovementsEdit [itemId=DirWarehouseIDFrom]': { select: this.onDirWarehouseIDFromSelect },
            'viewDocMovementsEdit button#btnDirWarehouseEditFrom': { click: this.onBtnDirWarehouseEditFromClick },
            'viewDocMovementsEdit button#btnDirWarehouseReloadFrom': { click: this.onBtnDirWarehouseReloadFromClick },
            //To
            'viewDocMovementsEdit [itemId=DirWarehouseIDTo]': { select: this.onDirWarehouseIDToSelect },
            'viewDocMovementsEdit button#btnDirWarehouseEditTo': { click: this.onBtnDirWarehouseEditToClick },
            'viewDocMovementsEdit button#btnDirWarehouseReloadTo': { click: this.onBtnDirWarehouseReloadToClick },

            //Курьер
            'viewDocMovementsEdit [itemId=DirEmployeeIDCourier]': { select: this.onDirEmployeeIDCourierSelect },
            'viewDocMovementsEdit button#btnDirEmployeeIDCourier': { click: this.onBtnDirEmployeeIDCourierClick },

            //PanelDocumentAdditionally
            //Склад - Перегрузить
            'viewDocMovementsEdit [itemId=DirVatValue]': { select: this.onDirVatValueSelect },
            'viewDocMovementsEdit [itemId=Payment]': { change: this.onPaymentChange },

            //PanelDocumentDiscount
            'viewDocMovementsEdit [itemId=Discount]': { change: this.onDiscount },
            'viewDocMovementsEdit button#btnSpreadDiscount': { click: this.onBtnSpreadDiscount },
            'viewDocMovementsEdit #SummOther': { select: this.onSummOther },
            'viewDocMovementsEdit button#btnSpreadSummOther': { click: this.onBtnSpreadSummOther },

            //PanelDocumentPay
            'viewDocMovementsEdit [itemId=PayZReport]': { change: this.onPayZReportChecked },

            //Грид (itemId=grid)
            'viewDocMovementsEdit button#btnGridAddPosition': { click: this.onGrid_BtnGridAddPosition },
            //'viewDocMovementsEdit menuitem#btnGridSelectionOfGoods': { click: this.onGrid_BtnGridSelectionOfGoods },

            'viewDocMovementsEdit button#btnGridEdit': { click: this.onGrid_BtnGridEdit },
            'viewDocMovementsEdit button#btnGridDelete': { click: this.onGrid_BtnGridDelete },
            'viewDocMovementsEdit button#btnGridPayment': { click: this.onGrid_BtnGridPayment },


            // Клик по Гриду
            'viewDocMovementsEdit [itemId=grid]': {
            ...
            'viewDocMovementsEdit button#btnHeldCancel': { click: this.onBtnHeldCancelClick },
            'viewDocMovementsEdit button#btnHelds': { click: this.onBtnHeldsClick },
            'viewDocMovementsEdit menuitem#btnSave': { click: this.onBtnSaveClick },
            'viewDocMovementsEdit menuitem#btnSaveClose': { click: this.onBtnSaveClick },
            'viewDocMovementsEdit button#btnCancel': { "click": this.onBtnCancelClick },
            'viewDocMovementsEdit button#btnHelp': { "click": this.onBtnHelpClick },
            //***
            'viewDocMovementsEdit menuitem#btnPrintHtml': { click: this.onBtnPrintHtmlClick },
            'viewDocMovementsEdit menuitem#btnPrintExcel': { click: this.onBtnPrintHtmlClick },
        });
    },
    ...
    onTree_folderNew: function (aButton, aEvent) {
        controllerDocMovementsEdit_onTree_folderNew(aButton.UO_id);
    },
    onTree_folderNewSub: function (aButton, aEvent) {
        controllerDocMovementsEdit_onTree_folderNewSub(aButton.UO_id);
    },
    onTree_FolderEdit: function (aButton, aEvent) {
        controllerDocMovementsEdit_onTree_folderEdit(aButton.UO_id);
    },
    onTree_FolderCopy: function (aButton, aEvent) {
        controllerDocMovementsEdit_onTree_folderCopy(aButton.UO_id);
    },
    onTree_folderDel: function (aButton, aEvent, aOptions) {
        controllerDocMovementsEdit_onTree_folderDel(aButton.UO_id);
    },
    ...
    onDirVatValueSelect: function (combo, records) {
        controllerDocMovementsEdit_RecalculationSums(combo.UO_id, false);
    },
    //Скидка
    onPaymentChange: function (aTextfield, aText) {
        controllerDocMovementsEdit_RecalculationSums(aTextfield.UO_id, false)
    },
        ...
        Ext.Msg.show({
            ...
            fn: function (btn) {
                if (btn == "yes") {
                    ...
                    funSpreadDiscount(aButton.UO_id, ArrPrice, controllerDocMovementsEdit_RecalculationSums);
                }
            },
    ...
    onBtnSpreadSummOther: function (aButton, aEvent) {
        Ext.Msg.show({
            ...
            fn: function (btn) {
                if (btn == "yes") {
                    var ArrPrice = ["PriceCurrency", "PriceVAT", "SUMPriceCurrency", "DirCurrencyRate", "DirCurrencyMultiplicity", "Quantity"];
                    funSpreadSummOther(aButton.UO_id, ArrPrice, controllerDocMovementsEdit_RecalculationSums);
                }
            },
            icon: Ext.window.MessageBox.QUESTION
        });
    ...
    onGrid_BtnGridAddPosition: function (aButton, aEvent, aOptions) {
        ...
        */
        ...
        ObjectEditConfig("viewDocMovementTabsEdit", Params);
    },
            ...
            fn: function (buttons) {
                if (buttons == "yes") {
                    ...
                    if (selection) {
                        ...
                        controllerDocMovementsEdit_RecalculationSums(aButton.UO_id, false)
                    }
                }
            }
        });
    ...
    onBtnHeldCancelClick: function (aButton, aEvent, aOptions) {
        Ext.MessageBox.show({
            ...
            fn: function (buttons) { if (buttons == "yes") { controllerDocMovementsEdit_onBtnSaveClick(aButton, aEvent, aOptions); } }
        });
    },

    //Провести
    onBtnHeldsClick: function (aButton, aEvent, aOptions) {
        controllerDocMovementsEdit_onBtnSaveClick(aButton, aEvent, aOptions);
    },
    ...
    onBtnPrintHtmlClick: function (aButton, aEvent, aOptions) {
        ...
        if (Ext.getCmp("DocMovementID" + aButton.UO_id).getValue() == null) { Ext.Msg.alert(lanOrgName, txtMsg066); return; }
...
//Функия сохранения
function controllerDocMovementsEdit_onBtnSaveClick(aButton, aEvent, aOptions) {
    ...
    if (Ext.getCmp("viewDocMovementsEdit" + id).UO_GridSave && (Ext.getCmp("DirEmployeeIDCourier" + id).getValue() == "" || Ext.getCmp("DirEmployeeIDCourier" + id).getValue() == null)) {
        Ext.Msg.alert(lanOrgName, "Выбирите Курьера!");
        return;
    }

    //Спецификация (табличная часть)
    var recordsDocMovementTab = [];
    var storeGrid = Ext.getCmp("grid_" + id).store;
    storeGrid.data.each(function (rec) { recordsDocMovementTab.push(rec.data); });
    ...
    var sMethod = "POST";
    var sUrl = HTTP_DocMovements + "?UO_Action=" + aButton.UO_Action;
    if (parseInt(Ext.getCmp("DocMovementID" + id).value) > 0) {
        sMethod = "PUT";
        sUrl = HTTP_DocMovements + "?id=" + parseInt(Ext.getCmp("DocMovementID" + id).value) + "&UO_Action=" + aButton.UO_Action;
    }
    ...
    widgetXForm.submit({
        ...
        params: { recordsDocMovementTab: Ext.encode(recordsDocMovementTab) },
        ...
        success: function (form, action) {
            ...
            if (!Ext.getCmp('DocID' + id).getValue()) {
                ...
                Ext.getCmp('DocMovementID' + id).setValue(sData.DocMovementID);
                Ext.getCmp('NumberInt' + aButton.UO_id).setValue(sData.DocMovementID);
                Ext.Msg.alert(lanOrgName, lanDataSaved + "<br />" + txtMsg096 + sData.DocMovementID + "<br />" + sMsg);

                Ext.getCmp('viewDocMovementsEdit' + aButton.UO_id).setTitle(Ext.getCmp('viewDocMovementsEdit' + aButton.UO_id).title + " (" + Ext.getCmp("DocMovementID" + aButton.UO_id).getValue() + ")");
...
function controllerDocMovementsEdit_RecalculationSums(id, ShowMsg) { 
    fun_DocX_RecalculationSums(id, ShowMsg);
    return;
    //Стор для "Табличной части"
    var storeGrid = Ext.getCmp(Ext.getCmp("form_" + id).UO_idMain).storeGrid; //storeDocMovementTabsGrid; //можно так: Ext.getCmp("viewDocMovementsEdit" + id).storeDocMovementTabsGrid;
...
function controllerDocMovementsEdit_onTree_folderNew(id) {
    var Params = [
        "tree_" + id,
        true, //UO_Center
        true, //UO_Modal
...
function controllerDocMovementsEdit_onTree_folderEdit(id) {
    var Params = [
        "tree_" + id,
        true, //UO_Center
        true, //UO_Modal
...
function controllerDocMovementsEdit_onTree_folderNewSub(id) {
    var node = funReturnNode(id);
...
function controllerDocMovementsEdit_onTree_folderCopy(id) {
    Ext.MessageBox.show({
...
function controllerDocMovementsEdit_onTree_folderDel(id) {
...
function controllerDocMovementsEdit_onTree_folderSubNull(id) {
    return;
...
function controllerDocMovementsEdit_onTree_addSub(id) {
