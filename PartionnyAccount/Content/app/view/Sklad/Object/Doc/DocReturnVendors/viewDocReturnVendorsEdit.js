Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocReturnVendors/viewDocReturnVendorsEdit", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocReturnVendorsEdit",

    layout: "border",
    region: "center",
    title: lanDocumentReturnVendor,
    ...
    initComponent: function () {
        ...
        var PanelDocumentDetails = Ext.create('Ext.panel.Panel', {
            ...
            items: [
...

                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: "№", name: "DocReturnVendorID", id: "DocReturnVendorID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true },
        ...
        */
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            store: this.storeGrid, //storeDocReturnVendorTabsGrid,
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocReturnVendorsEdit_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocReturnVendorsEdit_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocReturnVendorsEdit_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocReturnVendorsEdit_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocReturnVendorsEdit_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocReturnVendorsEdit_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocReturnVendorsEdit_onTree_addSub;
                        //Выводим
