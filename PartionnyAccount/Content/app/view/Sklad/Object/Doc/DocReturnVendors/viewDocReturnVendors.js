Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocReturnVendors/viewDocReturnVendors", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocReturnVendors",

    layout: "border",
    region: "center",
    title: lanJournalReturnVendor,
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocReturnVendorID", width: 50, tdCls: 'x-change-cell' }, //lanNumberSaleDocument
