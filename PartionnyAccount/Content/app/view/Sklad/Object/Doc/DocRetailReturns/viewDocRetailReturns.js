Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocRetailReturns/viewDocRetailReturns", {
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocRetailReturns",

    layout: "border",
    region: "center",
    title: "Возврат -> Список",
    ...
    //Контроллер
    controller: 'viewcontrollerDocRetailReturns',
    listeners: { close: 'onViewDocRetailReturnsClose' },
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocRetailReturnID", width: 50, tdCls: 'x-change-cell' },
