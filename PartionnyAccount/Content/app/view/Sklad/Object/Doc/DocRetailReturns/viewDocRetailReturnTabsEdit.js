Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocRetailReturns/viewDocRetailReturnTabsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocRetailReturnTabsEdit",

    layout: "border", //!!! Важно для Ресайз-а внутренней панели !!!
    width: 625, height: 290,
    region: "center",
    monitorValid: true,
    //autoScroll: false,
    ...
    //Контроллер
    controller: 'viewcontrollerDocRetailReturnTabsEdit',
                    ...
                    items: [

                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'viewComboBox',
                                    fieldLabel: "Тип", flex: 1, allowBlank: false,
