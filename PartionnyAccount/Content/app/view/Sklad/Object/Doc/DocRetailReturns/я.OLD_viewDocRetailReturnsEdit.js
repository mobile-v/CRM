    ...
    initComponent: function () {
            ...
            items: [
...

                {
                    ...
                    items: [
                        ...
                        { xtype: 'viewDateField', fieldLabel: "Дата", name: "DocDate", id: "DocDate" + this.UO_id, margin: "0 0 0 5", allowBlank: false, readOnly: true },
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            tbar: [
                ...
                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, style: "width: 120px; height: 40px;",
                    //xtype: "button",
                    icon: '../Scripts/sklad/images/table_add.png', text: "<font size=" + HeaderMenu_FontSize_1 + "><b>" + lanAddPosition + "</b></font>", tooltip: lanAddPosition,
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        //Скидка
                        {
                            ...
                            UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, hidden: true,
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            buttons: [
                ...
                {
                    id: "btnHeldCancel" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, itemId: "btnHeldCancel", style: "width: 120px; height: 40px;", hidden: true,
                ...
                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, itemId: "btnCancel", hidden: true,
                ...
                "-",
                {
                    ...
                    text: "<font size=" + HeaderMenu_FontSize_1 + "><b>" + lanHelp + "</b></font>", icon: '../Scripts/sklad/images/help16.png', hidden: true,
