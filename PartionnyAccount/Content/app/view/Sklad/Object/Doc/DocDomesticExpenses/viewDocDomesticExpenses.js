Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocDomesticExpenses/viewDocDomesticExpenses", {
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocDomesticExpenses",
    ...
    //Контроллер
    controller: 'viewcontrollerDocDomesticExpenses',
    listeners: { close: 'onViewDocDomesticExpensesClose' },
    ...
    initComponent: function () {
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDocRetail', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocDomesticExpenseID", width: 50, tdCls: 'x-change-cell' },
