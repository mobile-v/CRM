Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocPurches/viewDocPurches", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocPurches",
    ...
    initComponent: function () {
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                storeDirWarehousesGrid: this.storeDirWarehousesGrid,
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocPurchID", width: 50, tdCls: 'x-change-cell' }, //lanNumberPurchDocument
                    ...
                    { text: "Оплачен", dataIndex: "DocDatePayment", sortable: true, width: 75, tdCls: 'x-change-cell' },
                    ...
                    { text: lanSumOfVAT, dataIndex: "SumOfVATCurrency", sortable: true, width: 100, summaryType: 'sum', tdCls: 'x-change-cell' },
                    { text: lanSumVAT, dataIndex: "SumVATCurrency", hidden: true, summaryType: 'sum', tdCls: 'x-change-cell' },
                    { text: lanHavePay, dataIndex: "HavePay", width: 75, summaryType: 'sum', tdCls: 'x-change-cell' },
