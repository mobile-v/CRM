Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocPurches/viewDocPurchTabsEdit", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocPurchTabsEdit",

    layout: "border", //!!! Важно для Ресайз-а внутренней панели !!!
    width: 675, height: 435,
    region: "center",
    monitorValid: true,
    //autoScroll: false,
    ...
    initComponent: function () {
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                {
                    xtype: 'textfield',
                    allowBlank: true, flex: 1, fieldLabel: "DocInventoryID", //regex: /^[+\-]?\d+(?:\.\d+)?$/,
                    name: 'DocInventoryID', itemId: "DocInventoryID", id: "DocInventoryID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                    hidden: true,
                },

                {
                    xtype: 'textfield',
                    allowBlank: true, flex: 1, fieldLabel: "DocPurchID", //regex: /^[+\-]?\d+(?:\.\d+)?$/,
                    name: 'DocPurchID', itemId: "DocPurchID", id: "DocPurchID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                    hidden: true,
                },
                {
                    xtype: 'textfield',
                    allowBlank: true, flex: 1, fieldLabel: "DocPurchTabID", //regex: /^[+\-]?\d+(?:\.\d+)?$/,
                    name: 'DocPurchTabID', itemId: "DocPurchTabID", id: "DocPurchTabID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                    hidden: true,
                },
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype: 'textfield',
                                    allowBlank: true, flex: 1, fieldLabel: "Серийный номер", //regex: /^[+\-]?\d+(?:\.\d+)?$/,
                                ...
                                {
                                    xtype: 'textfield',
                                    allowBlank: true, flex: 1, fieldLabel: "Штрих-код", margin: "0 0 0 10", //regex: /^[+\-]?\d+(?:\.\d+)?$/, 
        ...
        this.buttons = [
            ...
            /*" ",
            {
                UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, itemId: "btnPrint",
                text: lanPrint, tooltip: lanPrint, icon: '../Scripts/sklad/images/print.png'
            },*/
            " ",
            {
