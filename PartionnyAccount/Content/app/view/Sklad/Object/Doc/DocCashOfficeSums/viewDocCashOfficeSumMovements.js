Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocCashOfficeSums/viewDocCashOfficeSumMovements", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocCashOfficeSumMovements",
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocCashOfficeSumMovementID", width: 50, tdCls: 'x-change-cell' }, //lanNumberPurchDocument
                    ...
                    { text: "Точка с", dataIndex: "DirWarehouseNameFrom", sortable: true, flex: 1, tdCls: 'x-change-cell' },
                    { text: "Касса с", dataIndex: "DirCashOfficeNameFrom", sortable: true, flex: 1, tdCls: 'x-change-cell' },
                    ...
                    { text: "Касса на", dataIndex: "DirCashOfficeNameTo", sortable: true, flex: 1, tdCls: 'x-change-cell' },
                    ...
                    { text: "Сумма", dataIndex: "Sums", sortable: true, width: 100, tdCls: 'x-change-cell' },
