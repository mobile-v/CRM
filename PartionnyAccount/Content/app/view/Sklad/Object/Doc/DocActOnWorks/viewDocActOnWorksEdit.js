Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocActOnWorks/viewDocActOnWorksEdit", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocActOnWorksEdit",

    layout: "border",
    region: "center",
    title: lanDocumentActOnWork,
    ...
    initComponent: function () {
        ...
        var PanelDocumentDetails = Ext.create('Ext.panel.Panel', {
            ...
            items: [
...

                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: "№", name: "DocActOnWorkID", id: "DocActOnWorkID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true },
...

                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'viewComboBox',
                            fieldLabel: "Магазин-склад", flex: 1, allowBlank: false, //, emptyText: "..."
                            margin: "0 0 0 5",
        ...
        */
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            store: this.storeGrid, //storeDocActOnWorkTabsGrid,
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocActOnWorksEdit_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocActOnWorksEdit_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocActOnWorksEdit_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocActOnWorksEdit_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocActOnWorksEdit_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocActOnWorksEdit_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocActOnWorksEdit_onTree_addSub;
                        //Выводим
