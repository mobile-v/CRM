Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocActOnWorks/viewDocActOnWorkTabsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocActOnWorkTabsEdit",
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                //DirNomen
                {
                    ...
                    items: [
                        //Тип цены - передаётся из вьюхи "viewDocActOnWorksEdit"
                        {
