Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocActWriteOffs/viewDocActWriteOffs", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocActWriteOffs",

    layout: "border",
    region: "center",
    title: lanJournalActWriteOff,
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocActWriteOffID", width: 50, tdCls: 'x-change-cell' }, //lanNumberActWriteOffDocument
