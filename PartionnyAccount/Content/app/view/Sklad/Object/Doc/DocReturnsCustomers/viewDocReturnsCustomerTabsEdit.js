Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocReturnsCustomers/viewDocReturnsCustomerTabsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocReturnsCustomerTabsEdit",
                ...
                //DirNomen
                {
                    ...
                    items: [
                        ...
                        //Партия
                        {
                            xtype: 'viewTriggerDirField',
                            allowBlank: false,
                            name: 'RemPartyMinusID', itemId: "RemPartyMinusID", id: "RemPartyMinusID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall
                        },
                    ]
                },
