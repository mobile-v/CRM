Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocReturnsCustomers/viewDocReturnsCustomers", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocReturnsCustomers",

    layout: "border",
    region: "center",
    title: lanJournalReturnsCustomers,
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocReturnsCustomerID", width: 50, tdCls: 'x-change-cell' }, //lanNumberReturnsCustomerDocument
                    { text: lanNumberInt, dataIndex: "NumberInt", hidden: true, tdCls: 'x-change-cell' }, //lanNumberReturnsCustomerDocument
