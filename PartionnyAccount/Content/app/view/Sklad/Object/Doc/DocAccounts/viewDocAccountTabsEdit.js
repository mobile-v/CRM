Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocAccounts/viewDocAccountTabsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocAccountTabsEdit",
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                //DirNomen
                {
                    ...
                    items: [
                        //Тип цены - передаётся из вьюхи "viewDocAccountsEdit"
                        {
