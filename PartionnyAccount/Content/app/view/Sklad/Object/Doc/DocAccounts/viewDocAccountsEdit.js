Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocAccounts/viewDocAccountsEdit", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocAccountsEdit",

    layout: "border",
    region: "center",
    title: lanDocumentAccount,
        ...
        var PanelDocumentDetails = Ext.create('Ext.panel.Panel', {
            ...
            items: [
...

                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: "№", name: "DocAccountID", id: "DocAccountID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true },
                ...
                */
                ...
                { // *** Создать на основании Расход.накл *** *** *** *** *** *** *** *** *** *** ***
                    ...
                    menu: [
                        {
                            UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                            icon: '../Scripts/sklad/images/table_relation.png', text: lanCreateDocSales, tooltip: lanCreateDocSales,
                            id: "btnCreateDocSales" + this.UO_id, itemId: "btnCreateDocSales"
                        },
                    ]
                } // *** Создать на основании Расход.накл *** *** *** *** *** *** *** *** *** *** ***
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocAccountsEdit_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocAccountsEdit_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocAccountsEdit_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocAccountsEdit_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocAccountsEdit_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocAccountsEdit_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocAccountsEdit_onTree_addSub;
                        //Выводим
