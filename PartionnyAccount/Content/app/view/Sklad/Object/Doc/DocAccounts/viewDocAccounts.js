Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocAccounts/viewDocAccounts", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocAccounts",

    layout: "border",
    region: "center",
    title: lanJournalAccounts,
        ...
        this.items = [
                ...
                root: {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            text: "На резерве",
                            leaf: true,
                            icon: '../Scripts/sklad/images/table_relation.png'
                        },
                    ]
                }
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocAccountID", width: 50, tdCls: 'x-change-cell' }, //lanNumberSaleDocument
