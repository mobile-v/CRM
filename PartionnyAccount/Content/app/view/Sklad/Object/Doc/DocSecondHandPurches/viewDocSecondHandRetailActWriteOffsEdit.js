Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocSecondHandPurches/viewDocSecondHandRetailActWriteOffsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocSecondHandRetailActWriteOffsEdit",
    ...
    //Контроллер
    controller: 'viewcontrollerDocSecondHandRetailActWriteOffsEdit',
    ...
    initComponent: function () {
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                //{ xtype: 'textfield', fieldLabel: "№", name: "DocSecondHandRetailReturnID", id: "DocSecondHandRetailReturnID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true, hidden: true },

                { xtype: 'textfield', fieldLabel: "№", name: "DocSecondHandRetailActWriteOffID", id: "DocSecondHandRetailActWriteOffID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true, hidden: true },
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            columns: [
                ...
                { text: "Партия списания", dataIndex: "Rem2PartyMinusID", width: 75, hidden: true },
                //Товар
