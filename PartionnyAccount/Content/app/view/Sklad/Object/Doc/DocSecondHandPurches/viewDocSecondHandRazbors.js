                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                { xtype: 'displayfield', fieldLabel: '<b>№ док.</b>', labelWidth: 100, name: "DocSecondHandPurchID", id: "DocSecondHandPurchID" + this.UO_id, readOnly: true, allowBlank: false, width: 250 },
                                                ...
                                                { xtype: 'displayfield', fieldLabel: '<b>ID0</b>', name: "ID0", id: "ID0" + this.UO_id, readOnly: true, allowBlank: false, hidden: true },
                                                { xtype: 'displayfield', fieldLabel: '<b>ID1</b>', name: "ID1", id: "ID1" + this.UO_id, readOnly: true, allowBlank: false, hidden: true },
                                                { xtype: 'displayfield', fieldLabel: '<b>ID2</b>', name: "ID2", id: "ID2" + this.UO_id, readOnly: true, allowBlank: false, hidden: true },

                                                { xtype: 'displayfield', fieldLabel: '<b>ID01</b>', name: "ID01", id: "ID01" + this.UO_id, readOnly: true, allowBlank: false, hidden: true },
                                                { xtype: 'displayfield', fieldLabel: '<b>ID11</b>', name: "ID11", id: "ID11" + this.UO_id, readOnly: true, allowBlank: false, hidden: true },
                                                { xtype: 'displayfield', fieldLabel: '<b>ID21</b>', name: "ID21", id: "ID21" + this.UO_id, readOnly: true, allowBlank: false, hidden: true },
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        
                        {
                            ...
                            id: "btnStatus12" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, itemId: "btnStatus12",
                        ...
                        },
                        {
                            ...
                            id: "btnStatus13" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, itemId: "btnStatus13",
                            enableToggle: true, pressed: false,
                            style: { background: '#90EE90' }
                        },
                        
                        /*{
                            xtype: "button", tooltip: "Списать с ЗП", icon: '../Scripts/sklad/images/Status/renouncement24.png', style: "width: 50px; height: 35px;", scale: 'large',
                            id: "btnStatus11" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, itemId: "btnStatus11",
                            enableToggle: true, pressed: false,
                        ...
                        { xtype: 'textfield', fieldLabel: "<b style='color: red;'>Сумма рем.</b>", labelAlign: 'top', name: "SumTotal2a", id: "SumTotal2a" + this.UO_id, regex: /^[+\-]?\d+(?:\.\d+)?$/, flex: 1, readOnly: true, allowBlank: true, hidden: true, fieldStyle: 'color: red; font-weight: bold;' },
                        {
                            ...
                            text: "<b style='font-size: 22px; color: red;'>В архив</b>", icon: '../Scripts/sklad/images/save_held.png',
                            hidden: true
                        },
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    ...
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocSecondHandRazbors_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocSecondHandRazbors_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocSecondHandRazbors_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocSecondHandRazbors_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocSecondHandRazbors_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocSecondHandRazbors_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocSecondHandRazbors_onTree_addSub;
                        //Выводим
