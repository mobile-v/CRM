Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocSecondHandPurches/viewDocSecondHandSalesEdit", {

    extend: InterfaceSystemObjName,
    alias: "widget.viewDocSecondHandSalesEdit",
    ...
    //Контроллер
    controller: 'viewcontrollerDocSecondHandSalesEdit',
    listeners: { close: 'onViewDocSecondHandSalesEditClose' },
    ...
    initComponent: function () {
        ...
        var PanelParty = Ext.create('widget.viewGridRem22', {
            ...
            store: this.storeDocSecondHandPurchesGrid,
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { 
            ...
            UO_idMain: this.UO_idMain, //id-шник Панели, на которой находятся виджеты
            UO_idCall: this.UO_idCall, //id-шник Виджета, который визвал Виджет
            UO_View: "viewDocSecondHandSalesEdit", // this.UO_View,     //Название Виджета на котором расположен Грид, нужен для "Стилей" (раскраска грида)
            ...
            tbar: [
                ...
                //Печать
                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                    //xtype: "button",
                    icon: '../Scripts/sklad/images/print.png', tooltip: "Печать", disabled: true, style: "width: 40px; height: 40px;",
                    itemId: "btnGridPF",
                    listeners: { click: 'onGrid_BtnGridPF' }
                },
                //KKM
                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
            ...
            Ext.create('widget.viewTreeDirRetail', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocSecondHandSalesEdit_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocSecondHandSalesEdit_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocSecondHandSalesEdit_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocSecondHandSalesEdit_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocSecondHandSalesEdit_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocSecondHandSalesEdit_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocSecondHandSalesEdit_onTree_addSub;
                        //Выводим
