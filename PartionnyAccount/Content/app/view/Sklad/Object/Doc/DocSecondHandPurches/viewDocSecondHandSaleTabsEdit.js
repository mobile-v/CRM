Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocSecondHandPurches/viewDocSecondHandSaleTabsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocSecondHandSaleTabsEdit",
    ...
    //Контроллер
    controller: 'viewcontrollerDocSecondHandSaleTabsEdit',
    ...
    initComponent: function () {
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                { xtype: 'textfield', fieldLabel: "DocSecondHandReturnID", name: "DocSecondHandReturnID", id: "DocSecondHandReturnID" + this.UO_id, readOnly: true, allowBlank: true, hidden: true },
                { xtype: 'textfield', fieldLabel: "DocSecondHandSaleID", name: "DocSecondHandSaleID", id: "DocSecondHandSaleID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true, hidden: true },
