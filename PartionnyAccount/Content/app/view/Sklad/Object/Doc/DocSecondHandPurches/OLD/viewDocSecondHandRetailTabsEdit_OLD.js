Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocSecondHandPurches/viewDocSecondHandRetailTabsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocSecondHandRetailTabsEdit",
    ...
    //Контроллер
    controller: 'viewcontrollerDocSecondHandRetailTabsEdit',
    ...
    initComponent: function () {
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                { xtype: 'textfield', fieldLabel: "DocSecondHandRetailReturnID", name: "DocSecondHandRetailReturnID", id: "DocSecondHandRetailReturnID" + this.UO_id, readOnly: true, allowBlank: true, hidden: true },
                ...
                //NumberReal == DocSecondHandRetailID
                //{ xtype: 'textfield', fieldLabel: "№", name: "NumberReal", id: "NumberReal" + this.UO_id, readOnly: true, flex: 1, allowBlank: true, hidden: true },
                { xtype: 'textfield', fieldLabel: "№", name: "DocSecondHandRetailID", id: "DocSecondHandRetailID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true, hidden: true },
                ...
                //Партия
                { xtype: 'textfield', fieldLabel: "Rem2PartyID", name: 'Rem2PartyID', itemId: "Rem2PartyID", id: "Rem2PartyID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, allowBlank: false, hidden: true },
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            store: this.storeGrid, //storeDocSecondHandRetailTabsGrid,
