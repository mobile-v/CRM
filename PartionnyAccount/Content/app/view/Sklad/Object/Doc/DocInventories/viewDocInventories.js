Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocInventories/viewDocInventories", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocInventories",

    layout: "border",
    region: "center",
    title: lanJournalInventory,
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocInventoryID", width: 50, tdCls: 'x-change-cell' }, //lanNumberActWriteOffDocument
                    { text: lanNumberInt, dataIndex: "NumberInt", hidden: true, tdCls: 'x-change-cell' }, //lanNumberActWriteOffDocument
                    ...
                    { text: "Точка", dataIndex: "DirWarehouseName", sortable: true, flex: 1, tdCls: 'x-change-cell' },
                    ...
                    { text: "Сотрудник", dataIndex: "DirEmployeeName", tdCls: 'x-change-cell' },
                ],
