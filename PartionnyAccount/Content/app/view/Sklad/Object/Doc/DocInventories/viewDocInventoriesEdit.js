Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocInventories/viewDocInventoriesEdit", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocInventoriesEdit",

    layout: "border",
    region: "center",
    title: lanDocumentInventory,
    ...
    initComponent: function () {
        ...
        /*var SearchType_values = [
            [1, 'В товаре (код)'],
            [12, 'В товаре (старый код)'],
            [13, 'В товаре (наименование)'],
        ...
        var PanelDocumentAdditionally = Ext.create('Ext.panel.Panel', {
            ...
            items: [

                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: "№", name: "DocInventoryID", id: "DocInventoryID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true },
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            store: this.storeGrid, //storeDocInventoryTabsGrid,
            ...
            columns: [
                ...
                //К-во
                { text: "К-во спис.", dataIndex: "Quantity_WriteOff", width: 75 },
                //Суммы
                ...
                //Приход
                //К-во
                { text: "К-во пост.", dataIndex: "Quantity_Purch", width: 75 },
                { text: "Цера роз.", dataIndex: "PriceRetailCurrency", width: 75, hidden: true },
            ...
            tbar: [
                ...
                /*{
                    ...
                    menu: [
                        {
                            UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                            icon: '../Scripts/sklad/images/table_add.png', text: "Списание", tooltip: "Списание",
                            id: "btnActWriteOffs" + this.UO_id, itemId: "btnActWriteOffs"
                        },
                        {
                            UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                            icon: '../Scripts/sklad/images/table_add.png', text: "Оприходование", tooltip: "Оприходование",
                            id: "btnPurches" + this.UO_id, itemId: "btnPurches"
                        },
                    ]
                },*/
                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                    //xtype: "button",
                    icon: '../Scripts/sklad/images/table_add.png', text: "Оприходывать", tooltip: lanAddPosition,
                    itemId: "btnGridAddPosition",
                },
                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
...

                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                    xtype: "button",
                    icon: '../Scripts/sklad/images/load_16.png', text: "Загрузить все Остатки", tooltip: "Загрузить все остатки по точке?",
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        { xtype: 'textfield', fieldLabel: "Сумма спис.", name: "SumOfVATCurrency", id: "SumOfVATCurrency" + this.UO_id, regex: /^[+\-]?\d+(?:\.\d+)?$/, flex: 1, readOnly: true, allowBlank: true },
                        { xtype: 'textfield', fieldLabel: "Сумма разницы розн.", labelWidth: 130, name: "SumMinus_PriceRetailCurrency", id: "SumMinus_PriceRetailCurrency" + this.UO_id, regex: /^[+\-]?\d+(?:\.\d+)?$/, flex: 1, readOnly: true, allowBlank: true, margin: "0 0 0 5" },
                    ]
                },
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocInventoriesEdit_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocInventoriesEdit_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocInventoriesEdit_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocInventoriesEdit_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocInventoriesEdit_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocInventoriesEdit_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocInventoriesEdit_onTree_addSub;
                        //Выводим
