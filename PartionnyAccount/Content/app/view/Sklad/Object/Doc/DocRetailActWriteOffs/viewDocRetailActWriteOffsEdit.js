Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocRetailActWriteOffs/viewDocRetailActWriteOffsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocRetailActWriteOffsEdit",

    layout: "border", //!!! Важно для Ресайз-а внутренней панели !!!
    width: 625, height: 235,
    region: "center",
    monitorValid: true,
    //autoScroll: false,
    defaultType: 'textfield',
    title: "Пометка на Списание",
    autoHeight: true,
    frame: true,
    border: false,
    resizable: false,
    ...
    //Контроллер
    controller: 'viewcontrollerDocRetailActWriteOffsEdit',
    ...
    initComponent: function () {
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                //{ xtype: 'textfield', fieldLabel: "№", name: "RemPartyMinusID", id: "RemPartyMinusID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true, hidden: true },
                ...
                { xtype: 'textfield', fieldLabel: "№", name: "DocRetailActWriteOffID", id: "DocRetailActWriteOffID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true, hidden: true },
                ...
                //Quantity + Price
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'textfield',
                            regex: /^[+\-]?\d+(?:\.\d+)?$/, allowBlank: false, flex: 1, fieldLabel: "<b>" + lanDiscount + "</b>", readOnly: false, margin: "0 0 0 10",
                ...
                {
                    xtype: 'viewComboBox',
                    fieldLabel: "Тип возврата", flex: 2, allowBlank: false,
...

                {
                    ...
                    /*valueField: 'DirDescriptionID',
                    hiddenName: 'DirDescriptionID',
                    displayField: 'DirDescriptionName',*/
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            columns: [
                ...
                { text: "Партия", dataIndex: "RemPartyMinusID", width: 75, hidden: true },
                //Товар
                ...
                { text: "Цвет", dataIndex: "DirCharColourName", width: 70 },
        ...
        this.buttons = [
                ...
                //Расчет - не работает
                {
                    ...
                    UO_Action: "held",
                    text: "<font size=" + HeaderMenu_FontSize_1 + "><b>" + "Пометить" + "</b></font>", icon: '../Scripts/sklad/images/save_held.png',
