Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocMovements/viewDocMovements", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocMovements",
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocMovementID", width: 50, tdCls: 'x-change-cell' }, //lanNumberPurchDocument
