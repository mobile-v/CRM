Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocMovements/viewDocMovementsEdit", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocMovementsEdit",
    ...
    initComponent: function () {
        ...
        var PanelDocumentDetails = Ext.create('Ext.panel.Panel', {
            ...
            items: [
...

                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: "№", name: "DocMovementID", id: "DocMovementID" + this.UO_id, readOnly: true, width: 150, allowBlank: true, labelAlign: "top" },
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            store: this.storeGrid, //storeDocMovementTabsGrid,
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocMovementsEdit_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocMovementsEdit_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocMovementsEdit_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocMovementsEdit_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocMovementsEdit_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocMovementsEdit_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocMovementsEdit_onTree_addSub;
                        //Выводим
        ...
        this.buttons = [
            ...
            {
                id: "btnHeldCancel" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, itemId: "btnHeldCancel", hidden: true, style: "width: 140px; height: 40px;",
