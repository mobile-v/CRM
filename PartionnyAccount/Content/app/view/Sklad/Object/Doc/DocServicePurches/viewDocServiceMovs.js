Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocServicePurches/viewDocServiceMovs", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocServiceMovs",
        ...
        this.items = [
            ...
            Ext.create('widget.viewGridDoc', {
                ...
                columns: [
                    ...
                    { text: "№", dataIndex: "DocServiceMovID", width: 50, tdCls: 'x-change-cell' }, //lanNumberPurchDocument
