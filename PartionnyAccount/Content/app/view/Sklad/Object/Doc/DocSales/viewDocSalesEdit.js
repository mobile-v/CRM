Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocSales/viewDocSalesEdit", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDocSalesEdit",
    ...
    initComponent: function () {
        ...
        var PanelDocumentDetails = Ext.create('Ext.panel.Panel', {
            ...
            items: [
...

                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: "№", name: "DocSaleID", id: "DocSaleID" + this.UO_id, readOnly: true, flex: 1, allowBlank: true },
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            store: this.storeGrid, //storeDocSaleTabsGrid,
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDocSalesEdit_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDocSalesEdit_onTree_folderNewSub;
                        contextMenuTree.folderEdit = controllerDocSalesEdit_onTree_folderEdit;
                        contextMenuTree.folderCopy = controllerDocSalesEdit_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDocSalesEdit_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDocSalesEdit_onTree_folderSubNull;
                        contextMenuTree.addSub = controllerDocSalesEdit_onTree_addSub;
                        //Выводим
