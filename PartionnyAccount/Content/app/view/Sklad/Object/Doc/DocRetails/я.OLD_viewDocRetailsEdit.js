Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocRetails/viewDocRetailsEdit", {
    ...
    initComponent: function () {
        ...
        var PanelParty = Ext.create('widget.viewGridRem', {
            ...
            columns: [
                //Партия
                { text: "Партия", dataIndex: "RemPartyID", width: 85, hidden: true }, //, hidden: true
                //Товар
                { text: "Код", dataIndex: "DirNomenID", width: 85, style: "height: 25px;" },
            ...
            items: [
...

                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'button', tooltip: "Clear", itemId: "btnDirContractorClear", text: "X", UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                            listeners: { click: 'btnDirContractorClear' }
                        }
                    ]
                }
            ]
        ...
        var PanelGrid = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            tbar: [

                {
                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                    //xtype: "button",
                    icon: '../Scripts/sklad/images/table_add.png', text: "<font size=" + HeaderMenu_FontSize_1 + "><b>" + lanAddPosition + "</b></font>", tooltip: lanAddPosition, style: "width: 120px; height: 40px;",
