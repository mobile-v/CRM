Ext.define("PartionnyAccount.view.Sklad/Object/Doc/DocRetails/viewDocRetailTabsEdit", {
    extend: "Ext.Window", UO_Extend: "Window", //extend: InterfaceSystemObjName,
    alias: "widget.viewDocRetailTabsEdit",
    ...
    //Контроллер
    controller: 'viewcontrollerDocRetailTabsEdit',
    ...
    initComponent: function () {
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                { xtype: 'textfield', fieldLabel: "DirPriceTypeID", name: 'DirPriceTypeID', itemId: "DirPriceTypeID", id: "DirPriceTypeID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, allowBlank: true, hidden: true },
                //Остаток: максимум сколько можно списать
                { xtype: 'textfield', fieldLabel: "Remnant", name: 'Remnant', itemId: "Remnant", id: "Remnant" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, allowBlank: true, hidden: true },
                //Партия
                { xtype: 'textfield', fieldLabel: "RemPartyID", name: 'RemPartyID', itemId: "RemPartyID", id: "RemPartyID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, allowBlank: false, hidden: true },
                ...
                //Партия
                //{ xtype: 'viewTriggerDirField', name: 'RemPartyID', itemId: "RemPartyID", id: "RemPartyID" + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall, allowBlank: false, },
                ...
                //ID-шники - some (некоторых) not visible
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'textfield',
                            fieldLabel: "Артикул", labelWidth: 75 , emptyText: "...", allowBlank: false, flex: 1, readOnly: true,
                        ...
                        {
                            xtype: 'textfield',
                            fieldLabel: "Имя товара", labelWidth: 75, emptyText: "...", allowBlank: false, flex: 2, readOnly: true, margin: "0 0 0 10",
                ...
                //Quantity + Price
                {
                    ...
                    items: [
                        ...
                        },*/
                        {
                            ...
                            allowBlank: false, flex: 1, fieldLabel: "<b>" + lanCount + "</b>", labelWidth: 75,
                            name: 'Quantity', itemId: 'Quantity', id: 'Quantity' + this.UO_id, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                        },
                        ...
                        {
                            xtype: 'textfield',
                            regex: /^[+\-]?\d+(?:\.\d+)?$/, allowBlank: false, flex: 1, fieldLabel: lanPrice, labelWidth: 75, readOnly: true, margin: "0 0 0 10",
                        ...
                        {
                            xtype: 'textfield',
                            regex: /^[+\-]?\d+(?:\.\d+)?$/, allowBlank: false, flex: 1, fieldLabel: "Скидка", labelWidth: 75, readOnly: false, margin: "0 0 0 10",
                    ...
                    items: [

                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'textfield',
                                    allowBlank: true, flex: 1, fieldLabel: "Телефон", labelWidth: 75,
                                ...
                                {
                                    xtype: 'textfield',
                                    allowBlank: true, flex: 1, fieldLabel: "E-Mail", labelWidth: 75, vtype: "email", margin: "0 0 0 10",
        ...
        this.buttons = [
                ...
                //Расчет - не работает
                {
                    ...
                    UO_Action: "held",
                    text: "<b style='font-size: 22px; color: green;'>" + lanCalculates + "</b>", //text: "<font size=" + HeaderMenu_FontSize_1 + "><b>" + lanCalculates + "</b></font>",
