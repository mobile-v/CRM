Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirServiceNomens/viewDirServiceNomenCategories", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirServiceNomenCategories",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirServiceNomenCategoryID", name: "DirServiceNomenCategoryID", id: "DirServiceNomenCategoryID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirServiceNomenCategoryName", id: "DirServiceNomenCategoryName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirServiceNomenCategories_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirServiceNomenCategories_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirServiceNomenCategories_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirServiceNomenCategories_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirServiceNomenCategories_onTree_folderSubNull;
                        //Выводим
