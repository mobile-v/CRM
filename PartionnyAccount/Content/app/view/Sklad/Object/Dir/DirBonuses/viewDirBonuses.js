Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirBonuses/viewDirBonuses", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirBonuses",
    ...
    initComponent: function () {
        ...
        var PanelGeneral = Ext.create('Ext.panel.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirBonusID", name: "DirBonusID", id: "DirBonusID" + this.UO_id, hidden: true }, //, readOnly: true
                //System record
                { xtype: "checkbox", boxLabel: "SysRecord", name: "SysRecord", id: "SysRecord" + this.UO_id, inputValue: true, hidden: true, readOnly: true },


                { xtype: 'textfield', fieldLabel: lanName, name: "DirBonusName", id: "DirBonusName" + this.UO_id, flex: 1, allowBlank: false },
        ...
        var PanelGridBonusTab = Ext.create('Ext.grid.Panel', {
            ...
            store: this.storeDirBonusTabsGrid,

            columns: [
                //{ text: "№", dataIndex: "DirBonusTabID", hidden: true },
                //{ text: "№", dataIndex: "DirBonusID", hidden: true },
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirBonuses_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirBonuses_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirBonuses_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirBonuses_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirBonuses_onTree_folderSubNull;
                        //Выводим
