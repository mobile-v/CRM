Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirDescriptions/viewDirDescriptions", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirDescriptions",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirDescriptionID", name: "DirDescriptionID", id: "DirDescriptionID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanValue, name: "DirDescriptionValue", id: "DirDescriptionValue" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirDescriptions_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirDescriptions_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirDescriptions_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirDescriptions_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirDescriptions_onTree_folderSubNull;
                        //Выводим
