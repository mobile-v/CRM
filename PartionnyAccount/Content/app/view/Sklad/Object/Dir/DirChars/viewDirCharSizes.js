Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharSizes", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharSizes",

    layout: "border",
    region: "center",
    title: lanCharacteristicSize,
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharSizeID", name: "DirCharSizeID", id: "DirCharSizeID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharSizeName", id: "DirCharSizeName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharSizes_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharSizes_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharSizes_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharSizes_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharSizes_onTree_folderSubNull;
                        //Выводим
