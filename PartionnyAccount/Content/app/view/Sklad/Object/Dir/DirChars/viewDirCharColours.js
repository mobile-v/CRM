Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharColours", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharColours",

    layout: "border",
    region: "center",
    title: lanCharacteristicColor,
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharColourID", name: "DirCharColourID", id: "DirCharColourID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharColourName", id: "DirCharColourName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharColours_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharColours_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharColours_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharColours_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharColours_onTree_folderSubNull;
                        //Выводим
