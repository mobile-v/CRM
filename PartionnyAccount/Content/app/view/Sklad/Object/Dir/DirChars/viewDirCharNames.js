Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharNames", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharNames",

    layout: "border",
    region: "center",
    title: lanCharacteristicProductName,
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharNameID", name: "DirCharNameID", id: "DirCharNameID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharNameName", id: "DirCharNameName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharNames_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharNames_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharNames_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharNames_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharNames_onTree_folderSubNull;
                        //Выводим
