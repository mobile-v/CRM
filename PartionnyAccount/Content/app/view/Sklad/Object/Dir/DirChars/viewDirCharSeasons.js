Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharSeasons", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharSeasons",

    layout: "border",
    region: "center",
    title: "Характеристика: Сезон",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharSeasonID", name: "DirCharSeasonID", id: "DirCharSeasonID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharSeasonName", id: "DirCharSeasonName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharSeasons_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharSeasons_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharSeasons_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharSeasons_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharSeasons_onTree_folderSubNull;
                        //Выводим
