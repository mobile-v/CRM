Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharStyles", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharStyles",

    layout: "border",
    region: "center",
    title: "Характеристика: Поставщик",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharStyleID", name: "DirCharStyleID", id: "DirCharStyleID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharStyleName", id: "DirCharStyleName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharStyles_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharStyles_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharStyles_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharStyles_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharStyles_onTree_folderSubNull;
                        //Выводим
