Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharTextures", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharTextures",

    layout: "border",
    region: "center",
    title: lanCharacteristicTexture,
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharTextureID", name: "DirCharTextureID", id: "DirCharTextureID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharTextureName", id: "DirCharTextureName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharTextures_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharTextures_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharTextures_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharTextures_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharTextures_onTree_folderSubNull;
                        //Выводим
