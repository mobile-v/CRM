Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharSexes", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharSexes",

    layout: "border",
    region: "center",
    title: "Характеристика: Пол",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharSexID", name: "DirCharSexID", id: "DirCharSexID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharSexName", id: "DirCharSexName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharSexes_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharSexes_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharSexes_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharSexes_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharSexes_onTree_folderSubNull;
                        //Выводим
