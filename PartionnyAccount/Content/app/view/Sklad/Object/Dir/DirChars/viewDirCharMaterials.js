Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirChars/viewDirCharMaterials", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirCharMaterials",

    layout: "border",
    region: "center",
    title: "Характеристика: Производитель",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirCharMaterialID", name: "DirCharMaterialID", id: "DirCharMaterialID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirCharMaterialName", id: "DirCharMaterialName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirCharMaterials_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirCharMaterials_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirCharMaterials_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirCharMaterials_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirCharMaterials_onTree_folderSubNull;
                        //Выводим
