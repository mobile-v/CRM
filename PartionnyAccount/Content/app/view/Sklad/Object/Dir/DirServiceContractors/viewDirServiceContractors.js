Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirServiceContractors/viewDirServiceContractors", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirServiceContractors",
    ...
    initComponent: function () {
        ...
        var PanelGeneral = Ext.create('Ext.panel.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirServiceContractorID", name: "DirServiceContractorID", id: "DirServiceContractorID" + this.UO_id, hidden: true }, //, readOnly: true
                //System record
...

                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirServiceContractorName", id: "DirServiceContractorName" + this.UO_id, flex: 1, allowBlank: false },
                    ]
                },
...

                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: lanAddress, name: "DirServiceContractorAddress", id: "DirServiceContractorAddress" + this.UO_id, flex: 1, allowBlank: true },
                ...
                //Скидка + Скидка
                {
                    ...
                    items: [
                        ...
                        //Скидка
                        { xtype: 'textfield', fieldLabel: lanFixedDiscount, margin: "0 0 0 10", name: "DirServiceContractorDiscount", id: "DirServiceContractorDiscount" + this.UO_id, regex: /^[+\-]?\d+(?:\.\d+)?$/, flex: 1, allowBlank: false },
                    ]
                },
                ...
                //Телефон + Факс
                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: lanPhone, name: "DirServiceContractorPhone", flex: 1, allowBlank: true },
                        { xtype: 'textfield', fieldLabel: lanFax, margin: "0 0 0 10", name: "DirServiceContractorFax", flex: 1, allowBlank: true }
                    ]
                },
                ...
                //EMail + WWW
                {
                    xtype: 'container', width: "95%", layout: { align: 'stretch', type: 'hbox' },
                    items: [
                        { xtype: 'textfield', fieldLabel: lanEMail, name: "DirServiceContractorEmail", flex: 1, allowBlank: true },
                        { xtype: 'textfield', fieldLabel: lanWWW, margin: "0 0 0 10", name: "DirServiceContractorWWW", flex: 1, allowBlank: true },
                    ]
                },
            ...
            /*items: [
                {
                    ...
                    center: {
                        ...
                        //geoCodeAddr: Ext.getCmp("DirServiceContractorAddress" + aButton.UO_id).value,
                        marker: {
                            title: 'Holmes Home'
                        }
                    },
        ...
        this.items = [
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                columns: [
                    ...
                    { text: 'Тип', dataIndex: 'DirServiceContractor2TypeName', width: 50, tdCls: 'x-change-cell' },
                ],
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirServiceContractors_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirServiceContractors_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirServiceContractors_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirServiceContractors_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirServiceContractors_onTree_folderSubNull;
                        //Выводим
