Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirNomens/viewDirNomenCategories", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirNomenCategories",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirNomenCategoryID", name: "DirNomenCategoryID", id: "DirNomenCategoryID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirNomenCategoryName", id: "DirNomenCategoryName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirNomenCategories_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirNomenCategories_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirNomenCategories_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirNomenCategories_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirNomenCategories_onTree_folderSubNull;
                        //Выводим
