Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirServiceComplects/viewDirServiceComplects", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirServiceComplects",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirServiceComplectID", name: "DirServiceComplectID", id: "DirServiceComplectID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirServiceComplectName", id: "DirServiceComplectName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirServiceComplects_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirServiceComplects_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirServiceComplects_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirServiceComplects_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirServiceComplects_onTree_folderSubNull;
                        //Выводим
