Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirMovementDescriptions/viewDirMovementDescriptions", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirMovementDescriptions",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirMovementDescriptionID", name: "DirMovementDescriptionID", id: "DirMovementDescriptionID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanValue, name: "DirMovementDescriptionValue", id: "DirMovementDescriptionValue" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirMovementDescriptions_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirMovementDescriptions_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirMovementDescriptions_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirMovementDescriptions_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirMovementDescriptions_onTree_folderSubNull;
                        //Выводим
