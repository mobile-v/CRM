Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirDomesticExpenses/viewDirDomesticExpenses", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirDomesticExpenses",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirDomesticExpenseID", name: "DirDomesticExpenseID", id: "DirDomesticExpenseID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //Наименование
                { xtype: 'textfield', fieldLabel: lanName, name: "DirDomesticExpenseName", id: "DirDomesticExpenseName" + this.UO_id, flex: 1, allowBlank: false },
                    ...
                    items: [

                        {
                            ...
                            store: new Ext.data.SimpleStore({
                                fields: ['DirDomesticExpenseType', 'DirDomesticExpenseTypeName'],
                                data: DirDomesticExpense_values
                            }),

                            valueField: 'DirDomesticExpenseType',
                            hiddenName: 'DirDomesticExpenseType',
                            displayField: 'DirDomesticExpenseTypeName',
                            name: 'DirDomesticExpenseType', itemId: "DirDomesticExpenseType", id: "DirDomesticExpenseType" + this.UO_id,
...

                        {
                            ...
                            margin: "0 0 0 5",
                            store: new Ext.data.SimpleStore({
                                fields: ['Sign', 'SignName'],
                                data: DirDomesticExpenses_Sign_values
                            }),

                            valueField: 'Sign',
                            hiddenName: 'Sign',
                            displayField: 'SignName',
                            name: 'Sign', itemId: "Sign", id: "Sign" + this.UO_id,
                            UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirDomesticExpenses_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirDomesticExpenses_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirDomesticExpenses_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirDomesticExpenses_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirDomesticExpenses_onTree_folderSubNull;
                        //Выводим
