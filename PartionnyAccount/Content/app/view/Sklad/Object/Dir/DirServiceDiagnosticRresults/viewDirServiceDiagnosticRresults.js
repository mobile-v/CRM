Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirServiceDiagnosticRresults/viewDirServiceDiagnosticRresults", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirServiceDiagnosticRresults",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirServiceDiagnosticRresultID", name: "DirServiceDiagnosticRresultID", id: "DirServiceDiagnosticRresultID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirServiceDiagnosticRresultName", id: "DirServiceDiagnosticRresultName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ],
        ...
        this.items = [
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                root: {
                    ...
                    text: 'Группа',
                    draggable: true,
                    id: "DirServiceDiagnosticRresult"
                },
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirServiceDiagnosticRresults_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirServiceDiagnosticRresults_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirServiceDiagnosticRresults_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirServiceDiagnosticRresults_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirServiceDiagnosticRresults_onTree_folderSubNull;
                        //Выводим
