Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirReturnTypes/viewDirReturnTypes", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirReturnTypes",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirReturnTypeID", name: "DirReturnTypeID", id: "DirReturnTypeID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanValue, name: "DirReturnTypeValue", id: "DirReturnTypeValue" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirReturnTypes_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirReturnTypes_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirReturnTypes_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirReturnTypes_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirReturnTypes_onTree_folderSubNull;
                        //Выводим
