Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirServiceProblems/viewDirServiceProblems", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirServiceProblems",
    ...
    initComponent: function () {
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                //ID
                { xtype: 'textfield', fieldLabel: "DirServiceProblemID", name: "DirServiceProblemID", id: "DirServiceProblemID" + this.UO_id, allowBlank: true, hidden: true }, //, readOnly: true
                //System record
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanName, name: "DirServiceProblemName", id: "DirServiceProblemName" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirServiceProblems_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirServiceProblems_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirServiceProblems_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirServiceProblems_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirServiceProblems_onTree_folderSubNull;
                        //Выводим
