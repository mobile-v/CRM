Ext.define("PartionnyAccount.view.Sklad/Object/Dir/DirVats/viewDirVats", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewDirVats",
        ...
        var formPanelEdit = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                //Наименование
                {
                    ...
                    items: [
                        { xtype: 'textfield', fieldLabel: lanValue, name: "DirVatValue", id: "DirVatValue" + this.UO_id, flex: 1, allowBlank: false }, //, readOnly: true
                    ]
                }
            ...
            Ext.create('widget.viewTreeDir', {
                ...
                listeners: {
                    itemcontextmenu: function (view, rec, node, index, e) {
                        ...
                        contextMenuTree.folderNew = controllerDirVats_onTree_folderNew;
                        contextMenuTree.folderNewSub = controllerDirVats_onTree_folderNewSub;
                        contextMenuTree.folderCopy = controllerDirVats_onTree_folderCopy;
                        contextMenuTree.folderDel = controllerDirVats_onTree_folderDel;
                        contextMenuTree.folderSubNull = controllerDirVats_onTree_folderSubNull;
                        //Выводим
