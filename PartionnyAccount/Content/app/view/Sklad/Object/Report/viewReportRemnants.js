Ext.define("PartionnyAccount.view.Sklad/Object/Report/viewReportRemnants", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewReportRemnants",
        ...
        var formPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [
...

                {
                    ...
                    items: [
                        { xtype: "checkbox", boxLabel: "Оперативные остатки", name: "OperationalBalances", itemId: "OperationalBalances", flex: 1, id: "OperationalBalances" + this.UO_id, inputValue: true, UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall },
                    ]
                },
