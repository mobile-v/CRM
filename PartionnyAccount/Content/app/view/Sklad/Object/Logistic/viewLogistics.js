Ext.define("PartionnyAccount.view.Sklad/Object/Logistic/viewLogistics", {
    //extend: "Ext.panel.Panel",
    extend: InterfaceSystemObjName,
    alias: "widget.viewLogistics",
    ...
    initComponent: function () {
        ...
        // 0. Все
        var PanelGrid0 = Ext.create('widget.viewGridLogistics', {
            conf: {
        ...
        var PanelGrid2 = Ext.create('widget.viewGridLogistics', {
            conf: {
        ...
        // 3. Курьер принял
        var PanelGrid3 = Ext.create('widget.viewGridLogistics', {
            conf: {
        ...
        // 4. Архив
        var PanelGrid9 = Ext.create('widget.viewGridLogistics', {
            conf: {
        ...
        var PanelGrid1 = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            hideHeaders: true,
            hidden: true,
            store: this.storeLogisticTabsGrid, //storeDocAccountTabsGrid,

            columns: [
                //Партия
                { text: "Партия", dataIndex: "RemXPartyID", width: 50, hidden: true },
                //Товар
                { text: "№", dataIndex: "DirNomenXID", width: 50, style: "height: 25px;" },
                { text: lanNomenclature, dataIndex: "DirNomenXName", flex: 1 },
                //К-во
        ...
        var PanelGridLog0 = Ext.create('Ext.grid.Panel', { //widget.viewGridDoc
            ...
            flex: 1,
            //split: true,
            store: this.storeLogLogisticsGrid0, //storeLogLogisticsGrid0,
            title: "Лог",
        ...
        var PanelFooter = Ext.create('Ext.panel.Panel', {
            ...
            items: [
                ...
                { xtype: 'textfield', fieldLabel: "DocTypeXID", name: "DocTypeXID", id: "DocTypeXID" + this.UO_id, readOnly: true, allowBlank: true, hidden: true },

                { xtype: 'textfield', fieldLabel: "DocID", name: "DocID", id: "DocID" + this.UO_id, readOnly: true, allowBlank: true, hidden: true },
                { xtype: 'textfield', fieldLabel: "LogisticID", name: "LogisticID", id: "LogisticID" + this.UO_id, readOnly: true, allowBlank: true, hidden: true },
