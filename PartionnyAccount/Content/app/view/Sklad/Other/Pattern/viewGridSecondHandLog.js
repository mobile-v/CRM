Ext.define("PartionnyAccount.view.Sklad/Other/Pattern/viewGridSecondHandLog", {
    extend: "Ext.grid.Panel",
    alias: "widget.viewGridSecondHandLog",
    ...
    viewConfig: {
        getRowClass: function (record, index) {
            ...
            for (var i = 0; i < record.store.model.fields.length; i++) {
                ...
                if (record.data["DirSecondHandLogTypeID"] == 12 && i == record.store.model.fields.length - 1) {
