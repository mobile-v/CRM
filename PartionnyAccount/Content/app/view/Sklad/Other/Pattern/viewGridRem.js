...
Ext.define("PartionnyAccount.view.Sklad/Other/Pattern/viewGridRem", {
    ...
    initComponent: function () {
        ...
        this.columns = [
            ...
            { text: "Поставщик", dataIndex: "DirContractorName", flex: 1, style: "height: 25px;", tdCls: 'x-change-cell' },
            { text: "Точка", dataIndex: "DirWarehouseName", width: 95, hidden: true, style: "height: 25px;", tdCls: 'x-change-cell' },
