...
Ext.define("PartionnyAccount.view.Sklad/Other/Pattern/viewGridRemPurch", {
    extend: "Ext.grid.Panel",
    alias: "widget.viewGridRemPurch",
    ...
    initComponent: function () {
        ...
        this.columns = [
            //Партия
            { text: "Партия", dataIndex: "RemPartyID", width: 85, hidden: true, tdCls: 'x-change-cell' }, //, hidden: true
            //Товар
            { text: "Код", dataIndex: "DirNomenID", width: 85, style: "height: 25px;", tdCls: 'x-change-cell' },
            { text: "Товар", dataIndex: "DirNomenName", flex: 1, style: "height: 25px;", tdCls: 'x-change-cell' },
            ...
            { text: "Точка", dataIndex: "DirWarehouseName", width: 95, style: "height: 25px;", tdCls: 'x-change-cell' },
            ...
            //{ text: "Цена Опт (в вал.)", dataIndex: "PriceWholeRetailVAT", width: 85, hidden: true, style: "height: 25px;", tdCls: 'x-change-cell' },
            //{ text: "Цена Опт", dataIndex: "PriceWholeRetailCurrency", width: 85, hidden: true, style: "height: 25px;", tdCls: 'x-change-cell' }, //, hidden: true

            //{ text: "Цена ИМ (в вал.)", dataIndex: "PriceIMVAT", width: 85, hidden: true, style: "height: 25px;", tdCls: 'x-change-cell' },
            //{ text: "Цена ИМ", dataIndex: "PriceIMCurrency", width: 85, hidden: true, style: "height: 25px;", tdCls: 'x-change-cell' }, //, hidden: true
            ...
            { text: "Стиль", dataIndex: "DirCharStyleName", width: 100, hidden: true, style: "height: 25px;", tdCls: 'x-change-cell' },
            //{ text: "Поставщик", dataIndex: "DirContractorName", width: 100, hidden: true, style: "height: 25px;", tdCls: 'x-change-cell' },
