            ...
            items: [
                    ...
                    items: [
                        {
                            ...
                            items: [
                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'viewComboBox',
                                                    fieldLabel: "Тип уст-ва", flex: 1, allowBlank: true, //Группа-3
                                                    //margin: "0 0 0 10",
                                                    store: this.storeDirServiceNomensGrid, // store getting items from server
                                                    valueField: 'DirServiceNomenID',
                                                    hiddenName: 'DirServiceNomenID',
                                                    displayField: 'DirServiceNomenName',
                                    ...
                                    items: [
...

                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'viewComboBox',
                                                    fieldLabel: "Товар", flex: 1, allowBlank: true, //Группа-3
                                                    margin: "0 0 0 10",
                                                ...
                                                { xtype: 'textfield', fieldLabel: "DirNomenName", name: "DirNomenName", id: "DirNomenName" + this.UO_id, readOnly: true, allowBlank: true, hidden: true }, //, hidden: true
                                ...
                                /*
                                {
                                    ...
                                    hiddenName: 'DirNomenID',
                                    displayField: 'DirNomenName',
                                    name: 'DirNomenID', itemId: "DirNomenID", id: "DirNomenID" + this.UO_id,
                                    UO_id: this.UO_id, UO_idMain: this.UO_idMain, UO_idCall: this.UO_idCall,
                                    //Поиск
                                    editable: true, typeAhead: true, minChars: 2,
                                },
                ...
                //Цена
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'textfield',
                            fieldLabel: "Предоплата", labelWidth: 75, regex: /^[+\-]?\d+(?:\.\d+)?$/, flex: 1,
                            margin: "0 0 0 15", name: "PrepaymentSum", id: "PrepaymentSum" + this.UO_id, allowBlank: false
                        },
                            ...
                            items: [
                                ...
                                //{ xtype: 'displayfield', fieldLabel: lanCount, name: "QuantityCount", id: "QuantityCount" + this.UO_id, allowBlank: false, flex: 1, margin: "0 0 0 5" },

                                  {
                                      ...
                                      margin: "0 0 0 15", name: "DateDone", id: "DateDone" + this.UO_id, allowBlank: false
                                  },
                            ]
                        },
