...
Ext.define("PartionnyAccount.view.Sklad/Other/Pattern/viewComboBoxTree",
//Ext.define('Ext.ux.TreeCombo',
    {
        extend: 'Ext.form.field.Picker',
        alias: 'widget.viewComboBoxTree',
        tree: false,
            ...
            me.tree = Ext.create('Ext.tree.Panel',
                {
                    ...
                    hidden: true,
                    minHeight: 175,
                    rootVisible: false, //rootVisible: (typeof me.rootVisible != 'undefined') ? me.rootVisible : true,
                    floating: true,
                    useArrows: true,
                    width: me.treeWidth,
                    autoScroll: true,
