Ext.define('PartionnyAccount.viewcontroller.Sklad/Object/Doc/DocServicePurches/viewcontrollerDocServiceMovTabsEdit', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.viewcontrollerDocServiceMovTabsEdit',
    ...
    onBtnSaveClick: function (aButton, aEvent, aOptions) {
        //fun_SaveTabDoc1(aButton, viewcontrollerDocServiceMovsEdit_RecalculationSums);
        ...
        if (widgetXForm.UO_GridIndex != undefined) {
            ...
            //Пересчитываем сумму
            viewcontrollerDocServiceMovsEdit_RecalculationSums(Ext.getCmp(aButton.UO_idCall).UO_id, false);
        }
        else {
            //INSERT
            //store.add(rec);
            ...
            //Поиск задвоенности === === === === === === === === === === ===  ===  ===  ===  === 
            //И сохранение
            //fun_SaveTabDoc2(rec, store, viewcontrollerDocServiceMovsEdit_RecalculationSums, Ext.getCmp(aButton.UO_idCall).UO_id, aButton.UO_idMain);
