Ext.define('PartionnyAccount.viewcontroller.Sklad/Object/Doc/DocSecondHandPurches/viewcontrollerDocSecondHandMovTabsEdit', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.viewcontrollerDocSecondHandMovTabsEdit',
    ...
    onBtnSaveClick: function (aButton, aEvent, aOptions) {
        //fun_SaveTabDoc1(aButton, viewcontrollerDocSecondHandMovsEdit_RecalculationSums);
        ...
        if (widgetXForm.UO_GridIndex != undefined) {
            ...
            //Пересчитываем сумму
            viewcontrollerDocSecondHandMovsEdit_RecalculationSums(Ext.getCmp(aButton.UO_idCall).UO_id, false);
        }
        else {
            //INSERT
            //store.add(rec);
            ...
            //Поиск задвоенности === === === === === === === === === === ===  ===  ===  ===  === 
            //И сохранение
            //fun_SaveTabDoc2(rec, store, viewcontrollerDocSecondHandMovsEdit_RecalculationSums, Ext.getCmp(aButton.UO_idCall).UO_id, aButton.UO_idMain);
