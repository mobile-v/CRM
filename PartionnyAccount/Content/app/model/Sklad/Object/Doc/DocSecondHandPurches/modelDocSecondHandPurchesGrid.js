...
Ext.define('PartionnyAccount.model.Sklad/Object/Doc/DocSecondHandPurches/modelDocSecondHandPurchesGrid', {
    ...
    fields: [
        ...
        { name: "DocSecondHandPurchID" }, //{ name: "DocSecondHandRazborID" }, //№ квитанции
        ...
        { name: "DateRetail", mapping: 'DateRetail', type: 'date' },
        { name: "DateReturn", mapping: 'DateReturn', type: 'date' },
    ]
});